...
<div class="container-fluid bg">
  ...
  <div class="col-md-8 margin paket">
	<div class="col-md-9 paket">
		<h3 class="margina">Lihat Detail Pesanan</h3>
	</div>
		...
		<table class="table table-hover" id="table">
		  ...
		  <?php
			...
			<tr>
			  ...
			  <td><?php echo "$post->Pesananid_pesanan"; ?></td>
			  <td><?php echo "Rp "."$post->total"; ?></td>
			  <td><?php echo "$post->status"; ?></td>
			  <td><?php echo "$post->bukti_bayar"; ?></td>
			</tr>
			<?php } ?>
  ...
  <div class="col-md-3" align="center">
	<form class="" action="<?php echo base_url(); ?>/ControllerAdmin/requestDescPesananPelanggan" method="post">
